...
if flag_plot_shap :
   ...
   sign_W_fun = (bnbot*bnbot-Omega*Omega)-(Omega*Omega-f_cor*f_cor)
   ...
   sign_W_fun_k1 = (bnbot*bnbot-Omega_k1*Omega_k1)-(Omega_k1*Omega_k1-f_cor*f_cor)
   ...
   sign1_W_fun = (bnbot*bnbot-Omega*Omega)
   ...
   sign2_W_fun = (Omega*Omega-f_cor*f_cor)
