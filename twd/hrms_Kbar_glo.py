...
mesh_file=str(sys.argv[17])
mesh_field=str(sys.argv[18])
...
if flag_outfield_plot :
   ...
   figname = figdir +'map_glo_hrms_'+str(boxdim)+'x'+str(boxdim)+'_'+str(napp_hk)+'.png'
   figtitle = 'HRMS'
   ...
   pcf  = plt.contourf(x,y,LAND, levels=[-15.0,0.000], colors='dimgray')
   ...
   figname = figdir +'map_glo_kbar_'+str(boxdim)+'x'+str(boxdim)+'_'+str(napp_hk)+'.png'
   figtitle = 'Kbar'
